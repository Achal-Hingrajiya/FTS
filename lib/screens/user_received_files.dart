...
class UserReceivedFiles extends StatefulWidget {
  const UserReceivedFiles({Key? key}) : super(key: key);

  @override
  State<UserReceivedFiles> createState() => _UserReceivedFilesState();
}

class _UserReceivedFilesState extends State<UserReceivedFiles> {
  @override
  void initState() {
    super.initState();
  }
      ...
      body: Column(
        children: [
          Container(
            ...
            child: Text("Documents received by Achal",
                style: TextStyle(
                    fontSize: 32,
                    color: Colors.white,
